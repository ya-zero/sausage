pipeline {
    ...
    post{  //после всей сборки
             success{
                sh  """ curl -X POST -H 'Content-type: application/json' --data '{"chat_id": "-1001634310929", "text": "Александр Возный собрал приложение."}' https://api.telegram.org/bot5933756043:AAE8JLL5KIzgrNBeTP5e-1bkbJy4YRoeGjs/sendMessage"""
                   }
              }
